...
Note that if the detectors are grouped before, this assume that the any grouped detectors belong to the instrument component of the first member of the group identifying it's parents for the LevelsUp parameter.
*WIKI*/
